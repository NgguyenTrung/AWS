...
1. In AWS Amplify, choose: `energy-waste-dashboard`.
2. Open **App settings** -> **General settings**.
3. Scroll to the bottom and select **Delete app**.
