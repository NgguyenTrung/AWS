...
![Create bucket](/images/5-Workshop/5.3-budget-and-region/create-bucket.png)

3. Trong Create bucket console
+ Äáº·t tÃªn bucket: chá»n 1 tÃªn mÃ  khÃ´ng bá»‹ trÃ¹ng trong pháº¡m vi toÃ n cáº§u (gá»£i Ã½: lab\<sá»‘-lab\>\<tÃªn-báº¡n\>)

![Bucket name](/images/5-Workshop/5.3-budget-and-region/bucket-name.png)


+ Giá»¯ nguyÃªn giÃ¡ trá»‹ cá»§a cÃ¡c fields khÃ¡c (default)
+ KÃ©o chuá»™t xuá»‘ng vÃ  chá»n **Create bucket**

![Create](/images/5-Workshop/5.3-budget-and-region/create-button.png)    

+ Táº¡o thÃ nh cÃ´ng S3 bucket

![Success](/images/5-Workshop/5.3-budget-and-region/bucket-success.png)
...
![system manager](/images/5-Workshop/5.3-budget-and-region/sm.png)

2. Tá»« **Systems Manager** menu, tÃ¬m **Node Management** á»Ÿ thanh bÃªn trÃ¡i vÃ  chá»n **Session Manager**:

![system manager](/images/5-Workshop/5.3-budget-and-region/sm1.png)
...
![Start session](/images/5-Workshop/5.3-budget-and-region/start-session.png)

Session Manager sáº½ má»Ÿ browser tab má»›i vá»›i shell prompt: sh-4.2 $

![Success](/images/5-Workshop/5.3-budget-and-region/start-session-success.png)
...
![Change user's dir](/images/5-Workshop/5.3-budget-and-region/cli1.png)
...
![Create file](/images/5-Workshop/5.3-budget-and-region/cli-file.png)
...
![Uploaded](/images/5-Workshop/5.3-budget-and-region/uploaded.png)
