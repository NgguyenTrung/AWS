...
![dns name](/images/5-Workshop/5.4-dynamodb/dns.png)

#### Káº¿t ná»‘i Ä‘áº¿n EC2 instance á»Ÿ trong "VPC On-prem" (giáº£ láº­p mÃ´i trÆ°á»ng truyá»n thá»‘ng)

1. Äi Ä‘áº¿n **Session manager** báº±ng cÃ¡ch gÃµ "session manager" vÃ o Ã´ tÃ¬m kiáº¿m
...
![Start session](/images/5-Workshop/5.4-dynamodb/start-session.png)

3. Äi Ä‘áº¿n ssm-user's home directory vá»›i lá»‡nh "cd ~"
...
![user](/images/5-Workshop/5.4-dynamodb/cli1.png)
...
![copy file](/images/5-Workshop/5.4-dynamodb/cli2.png)
...
![check bucket](/images/5-Workshop/5.4-dynamodb/check-bucket.png)
