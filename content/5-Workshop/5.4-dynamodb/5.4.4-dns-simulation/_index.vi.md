...
![hosted zone](/images/5-Workshop/5.4-dynamodb/hosted-zone.png)

2. Táº¡o 1 record má»›i trong Private Hosted Zone:

![Create record](/images/5-Workshop/5.4-dynamodb/create-record1.png)
...
![record1](/images/5-Workshop/5.4-dynamodb/record1.png)
...
![record 2](/images/5-Workshop/5.4-dynamodb/record2.png)

Record má»›i xuáº¥t hiá»‡n trÃªn giao diá»‡n Route 53.

![result](/images/5-Workshop/5.4-dynamodb/result.png)
...
![Inbound endpoint](/images/5-Workshop/5.4-dynamodb/route53-1.png)

3. Sao chÃ©p 2 Ä‘á»‹a chá»‰ IP trong danh sÃ¡ch vÃ o trÃ¬nh chá»‰nh sá»­a.

![Ip addresses](/images/5-Workshop/5.4-dynamodb/route53-2.png)

4. Tá»« giao diá»‡n Route 53, chá»n  **Resolver** > **Rules** vÃ  chá»n **Create rule**

![Ip addresses](/images/5-Workshop/5.4-dynamodb/route53-3.png)
...
![create rule](/images/5-Workshop/5.4-dynamodb/route53-4.png)

+ VPC: VPC On-prem
+ Outbound endpoint: VPCOnpremOutboundEndpoint

![create rule](/images/5-Workshop/5.4-dynamodb/route53-5.png)
...
![create rule](/images/5-Workshop/5.4-dynamodb/dig.png)
...
![create rule](/images/5-Workshop/5.4-dynamodb/subnet.png)
