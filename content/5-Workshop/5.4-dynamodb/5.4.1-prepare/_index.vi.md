...
Äá»ƒ chuáº©n bá»‹ cho pháº§n nÃ y cá»§a workshop, báº¡n sáº½ cáº§n pháº£i:
...
![route 53 diagram](/images/5-Workshop/5.4-dynamodb/route53.png)
...
![Create stack](/images/5-Workshop/5.4-dynamodb/create-stack.png)

![Button](/images/5-Workshop/5.4-dynamodb/create-stack-button.png)
...
Workshop nÃ y sá»­ dá»¥ng StrongSwan VPN cháº¡y trÃªn EC2 instance Ä‘á»ƒ mÃ´ phá»ng kháº£ nÄƒng káº¿t ná»‘i giá»¯a trung tÃ¢m dá»¯ liá»‡u truyá»n thá»‘ng vÃ  mÃ´i trÆ°á»ng cloud AWS. Háº§u háº¿t cÃ¡c thÃ nh pháº§n báº¯t buá»™c Ä‘á»u Ä‘Æ°á»£c cung cáº¥p trÆ°á»›c khi báº¡n báº¯t Ä‘áº§u. Äá»ƒ hoÃ n táº¥t cáº¥u hÃ¬nh VPN, báº¡n sáº½ sá»­a Ä‘á»•i báº£ng Ä‘á»‹nh tuyáº¿n "VPC on-prem" Ä‘á»ƒ hÆ°á»›ng lÆ°u lÆ°á»£ng Ä‘áº¿n cloud Ä‘i qua StrongSwan VPN instance.
