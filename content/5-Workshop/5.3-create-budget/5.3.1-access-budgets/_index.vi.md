...
Để bắt đầu cấu hình, bạn cần truy cập vào trang quản lý ngân sách bằng một trong hai cách sau:

* **Cách 1:** Trên thanh search của AWS Console, gõ `Budgets` và chọn service **AWS Budgets**.
...
> *Hình 5.3.1: Giao diện trang chủ Billing and Cost Management.*